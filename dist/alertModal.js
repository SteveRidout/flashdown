...
var show = function (message) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.clear();
                // XXX Consider indenting the whole of this instead of just the first line.
                console.log(renderUtils.reflowText({ text: "  " + message }, config_1.default.maxColumnWidth).text);
                console.log();
                console.log();
                console.log(chalk_1.default.greenBright("  Hit SPACE to go back"));
